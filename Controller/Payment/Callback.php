...
namespace CoolPay\Payment\Controller\Payment;
...
{
    const PRIVATE_KEY_XML_PATH           = 'payment/coolpay/private_key';
    const TESTMODE_XML_PATH              = 'payment/coolpay/testmode';
    const TRANSACTION_FEE_LABEL_XML_PATH = 'payment/coolpay/transaction_fee_label';
    ...
    public function execute()
    {
        ...
        try {
            ...
            $submittedChecksum = $this->getRequest()->getServer('HTTP_COOLPAY_CHECKSUM_SHA256');
