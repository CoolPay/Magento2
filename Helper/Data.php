<?php
namespace CoolPay\Payment\Helper;
...
{
    const PAYMENT_METHODS_XML_PATH = 'payment/coolpay/payment_methods';
    const SPECIFIED_PAYMENT_METHOD_XML_PATH = 'payment/coolpay/payment_method_specified';
