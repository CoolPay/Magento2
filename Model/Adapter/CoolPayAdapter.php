<?php
namespace CoolPay\Payment\Model\Adapter;
...
/**
 * Class CoolPayAdapter
 */
class CoolPayAdapter
{
    const PUBLIC_KEY_XML_PATH      = 'payment/coolpay/public_key';
    const TRANSACTION_FEE_XML_PATH = 'payment/coolpay/transaction_fee';
    const AUTOCAPTURE_XML_PATH = 'payment/coolpay/autocapture';
    const TEXT_ON_STATEMENT_XML_PATH = 'payment/coolpay/text_on_statement';
    ...
    /**
     * @var \CoolPay\Payment\Helper\Data
     */
    protected $helper;
    ...
    /**
     * CoolPayAdapter constructor.
     *
     * @param LoggerInterface $logger
     * @param UrlInterface $url
     * @param \CoolPay\Payment\Helper\Data $helper
    ...
    public function __construct(
        ...
        UrlInterface $url,
        \CoolPay\Payment\Helper\Data $helper,
    ...
    public function authorizeAndCreatePaymentLink(array $attributes)
    {
        try {
            ...
            $parameters = [
                ...
                "continueurl"        => $this->url->getUrl('coolpay/payment/returnAction'),
                "cancelurl"          => $this->url->getUrl('coolpay/payment/cancelAction'),
                "callbackurl"        => $this->url->getUrl('coolpay/payment/callback'),
